  ...
  <div class="container container-7 clearfix">
    <div class="highlight clearfix">
      ...
      <div class="container container-9 clearfix">
        <div class="container _element container-10"></div>
        <div class="container container-11 clearfix">
          <p class="text text-4">NEWS HEADING</p>
          <p class="text text-5">Nov 16, 2014</p>
          <p class="text text-6">Some advantages of Cold Heading a part over using a CNC Lathe or Swiss Screw Machine include reduced part cost both through production speed (60-400 parts per minute) and the minimal scrap generated from a cold headed part. Because the part is formed the grain flow stays intact and creates a much stronger part for its size.</p>
        </div>
      </div>
      <div class="container container-12 clearfix">
        <div class="container _element container-13"></div>
        <div class="container container-14 clearfix">
          <p class="text text-7">NEWS HEADING</p>
          <p class="text text-8">Nov 16, 2014</p>
          <p class="text text-9">An important consideration in heading is the tendency for the wire to buckle if its unsupported length to diameter ratio is too high. This ratio usually is limited to less than 3:1 but with appropriate dies, it can be higher.

There are a variety of cold heading machines but typically for Fastener manufacturing you will see One Die Two Blow up to Five Die Six Blow and beyond. Multi-Die headers allow for more complex parts to be formed as part of one process due to the above limitations of diameter ratio reductions.</p>
        </div>
      </div>
    </div>
  </div>
...
In a letter to the BBC Trust, the corporation's governing body, Ms Castro said Clarkson's behaviour in the country fell "well below" BBC editorial values, accusing them of "covering up".</p>
        ...
        <div class="container container-27 clearfix">
          <p class="text text-20">&lt; NEWER &nbsp;/ &nbsp;OLDER &gt;</p>
        </div>
      </div>
